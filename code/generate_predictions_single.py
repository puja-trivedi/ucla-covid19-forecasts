...
json_file_name = val_dir + args.dataset + "_" + "Single_val_params_best_END_DATE_" + args.END_DATE + "_VAL_END_DATE_" + args.VAL_END_DATE + file_name
if not os.path.exists(json_file_name):
    json_file_name = val_dir + "JHU" + "_" + "Single_val_params_best_END_DATE_" + args.END_DATE + "_VAL_END_DATE_" + args.VAL_END_DATE + file_name
...
for region in region_list:
    ...
    print (full_data[0][0].shape)

    confirm = full_data[-1][0][0:-1].tolist() + pred_true[0].tolist()
...
save_name = pred_dir + "Single_pred" + file_name + "_END_DATE_" + args.END_DATE + "_PRED_START_DATE_" + PRED_START_DATE + ".csv"
